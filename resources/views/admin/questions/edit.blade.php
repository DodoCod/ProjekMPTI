        ...
        <div class="mt-6 bg-white border border-blue-100 shadow-md rounded-xl p-6">
            ...
            <ul class="text-xs text-gray-600 space-y-2 ml-4 list-none">
                <li class="flex items-start">
                    ...
                    <span>Pastikan perubahan tidak mengubah makna pertanyaan secara signifikan</span>
                </li>
                <li class="flex items-start">
                    <span class="text-blue-600 mr-2 font-bold">•</span>
                    <span>Nomor soal harus unik dan tidak duplikat dengan pertanyaan lain</span>
                </li>
                <li class="flex items-start">
                    <span class="text-blue-600 mr-2 font-bold">•</span>
                    <span>Perubahan kategori akan mempengaruhi perhitungan skor DASS-42</span>
                </li>
            </ul>
        </div>
    </div>
